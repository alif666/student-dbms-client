...
export default {
  ...
  window.removeEventListener("gesturestart", this.gestureStart);
  window.removeEventListener("gesturechange", this.gestureChange);
  window.removeEventListener("gestureend", this.gestureEnd);
  window.removeEventListener("touchstart", this.touchStart);
  window.removeEventListener("touchmove", this.touchMove);
  window.removeEventListener("touchend", this.touchEnd);
  window.removeEventListener("beforeinput", this.manageUndoRedo);
  window.removeEventListener("input", this.manageUndoRedo);
},
