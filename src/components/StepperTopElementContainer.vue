...
<template>
    <v-container class= "mt-n16 mb-6">
        <v-sheet rounded class="d-flex flex-column align-center mt-n16 mb-16">

            <v-img v-if="itemProps==='1'" src="@/assets/setup_image.png" alt="User Icon" rounded class="stepper_icon icon-image"
